...
def create_train_validation_loaders(
    ...
    #  you create.
    # ====== YOUR CODE: ======
    dl_train = DataLoader(dataset, batch_size=batch_size, sampler=FirstLastSampler(dataset))
    dl_valid = DataLoader(dataset, batch_size=batch_size, sampler=FirstLastSampler(dataset))
    # ========================
